            ...
            <div class="col-md-6 col-lg-4 py-3 wow zoomIn">
                <div class="card-doctor d-flex flex-column">
                    ...
                    <div class="body mt-auto">
                        <p class="mb-0-custom font-lato" style="font-size: 13px">Д-р Иванка Кулевска-Гоновска</p>
                        <span class="text-sm-custom text-grey-custom font-open-sans">Кардиолог</span>
                    </div>
                    <div class="body mt-auto">
                        <h6 class="heading-custom">Образование</h6>
                        <p class="description-custom font-lato">Завършва Медицински университет София в 2011 г. Своята специалност Кардиология придобива през 2016 г. Успешно завършва магистратура по Социална медицина и здравен мениджмънт.</p>
                        <h6 class="heading-custom">Квалификации</h6>
                        <ul class="ul-style-custom">
                            <li class="ul-li-custom font-lato">Член на Български лекарски съюз и Дружество на кардиолозите в България;</li>
                            <li class="ul-li-custom font-lato">Член на ESC (Европейско дружество на кардиолозите);</li>
                            <li class="ul-li-custom font-lato">Участие в многобройни европейски, национални конгреси и семинари по специалността.</li>
                        </ul>
                        <h6 class="heading-custom">Биография</h6>
                        <p class="description-custom font-lato">След своето дипломиране 2012 г. д-р Кулевска-Гоновска работи в УМБАЛ Царица Йоанна - ИСУЛ София, МЦ Димед и ДКЦ 6 Пловдив. Към момента приема пациенти в собствен кабинет в Пловдив и Асеновград и е част от екипа специалисти на ДКЦ Пълмед Пловдив. Владее английски и немски език.</p>
                ...
                <div class="col-md-6 col-lg-4 py-3 wow zoomIn">
                    <div class="card-doctor d-flex flex-column">
                        ...
                        <div class="body mt-auto">
                            <p class="mb-0 font-lato" style="font-size: 13px">Д-р Кристиян Гоновски</p>
                            <span class="text-sm text-grey font-open-sans">Ортопед</span>
                            <div class="description mt-2 font-lato" style="font-size: 12px;">
                            <h6 class="heading-custom">Образование</h6>
