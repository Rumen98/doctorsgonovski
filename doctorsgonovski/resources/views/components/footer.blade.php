        ...
        <div class="row px-md-3 g-3">
            ...
            <div class="col-sm-6 col-lg-3 py-3">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="#" class="text-decoration-none">Advertise</a></li>
                    <li><a href="#" class="text-decoration-none">Join as Doctors</a></li>
                </ul>
            </div>
            <div class="col-sm-6 col-lg-3 py-3">
                <h5>Our partner</h5>
                <ul class="list-unstyled">
                    ...
                    <li><a href="#" class="text-decoration-none">One-Live</a></li>
                </ul>
            </div>
            <div class="col-sm-6 col-lg-3 py-3">
                <h5>Contact</h5>
